...
class MainViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var today: [PFObject]?
    var cell: ReceptionTableViewCell!
...
//    func tabColor0 (cell: ReceptionTableViewCell?) {
//        if parseClass == "Today" {
//            UIView.animateWithDuration(1, animations: {
//                
//                cell!.todaySideImageView.alpha = 1
////                UIView.animateWithDuration(1, animations: {
...
//                1, animations: {
//                    cell!.upcomingSideImageView!.alpha = 1
////                UIView.animateWithDuration(1, animations: {
...
//    }
//    
//    func tabColor1 (cell: ReceptionTableViewCell!) {
//            
//            if parseClass == "Today" {
//                
//                                                    UIView.animateWithDuration(1, animations: {
//                                        cell.upcomingSideImageView.alpha = 0
//                                        print("CHANGEDDDDDDDDDD Upcoming back to 0000000000")
//                                    })
//                
//                    
...
//                
//                                        UIView.animateWithDuration(1, animations: {
//                                            cell.todaySideImageView.alpha = 0
//                                            print("CHANGEDDDDDDDDDD today back to 0000000000")
//                                        })
//                
//                
